...
const YTIcon = () => (<svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-2.7 12.57 12.57 0 00-8.45 0 4.83 4.83 0 01-3.77 2.7A48.78 48.78 0 002 12a48.78 48.78 0 001.6 5.31 4.83 4.83 0 003.77 2.7 12.57 12.57 0 008.45 0 4.83 4.83 0 003.77-2.7A48.78 48.78 0 0022 12a48.78 48.78 0 00-2.41-5.31zM10 15V9l5 3z"/></svg>);
...
// Capital Brix's own profiles (src/data/site.js). No X icon: there is no
// Capital Brix handle, and linking someone else's is worse than none.
const ICON = { YouTube: <YTIcon />, Instagram: <IGIcon />, LinkedIn: <LIIcon />, Facebook: <FBIcon /> };
const socialLinks = site.socials.map((s) => ({ ...s, icon: ICON[s.name], label: s.name }));
  ...
  return (
    ...
    >
      <div className="max-w-[1600px] mx-auto px-4 lg:px-8 py-3 flex justify-between items-center">
        ...
        {/* ── Desktop Right: Socials + Search + Login ── */}
