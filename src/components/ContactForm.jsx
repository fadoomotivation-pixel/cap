          ...
          <div className="w-full lg:w-2/5 bg-[#101010] text-white p-10 md:p-14">
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-4">
                <Phone className="text-[#9C7C1C] mt-1 flex-shrink-0" size={24} />
                <div>
              ...
              <div className="flex items-start gap-4">
                <Mail className="text-[#9C7C1C] mt-1 flex-shrink-0" size={24} />
                <div>
              ...
              <div className="flex items-start gap-4">
                <MapPin className="text-[#9C7C1C] mt-1 flex-shrink-0" size={24} />
                <div>
          ...
          <div className="w-full lg:w-3/5 p-10 md:p-14">
            <form className="grid grid-cols-1 md:grid-cols-2 gap-8" onSubmit={handleSubmit}>
              ...
              <div className="flex flex-col gap-2">
                ...
                <input type="text" placeholder="John" required={true} value={form.first} onChange={(e) => setForm({ ...form, first: e.target.value })} className="w-full px-0 py-2 border-b-2 border-gray-200 focus:outline-none focus:border-[#D4AF37] transition-colors bg-transparent" />
              </div>
              
              <div className="flex flex-col gap-2">
                <label className="text-sm font-semibold text-gray-700">Last Name</label>
                <input type="text" placeholder="Doe" required={false} value={form.last} onChange={(e) => setForm({ ...form, last: e.target.value })} className="w-full px-0 py-2 border-b-2 border-gray-200 focus:outline-none focus:border-[#D4AF37] transition-colors bg-transparent" />
              </div>

              <div className="flex flex-col gap-2">
                <label className="text-sm font-semibold text-gray-700">Email Address</label>
                <input type="email" placeholder="john@example.com" required={false} value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} className="w-full px-0 py-2 border-b-2 border-gray-200 focus:outline-none focus:border-[#D4AF37] transition-colors bg-transparent" />
              </div>

              <div className="flex flex-col gap-2">
                <label className="text-sm font-semibold text-gray-700">Phone Number</label>
                <input type="tel" placeholder="+91 00000 00000" required={true} value={form.phone} onChange={(e) => setForm({ ...form, phone: e.target.value })} className="w-full px-0 py-2 border-b-2 border-gray-200 focus:outline-none focus:border-[#D4AF37] transition-colors bg-transparent" />
              </div>

              <div className="flex flex-col gap-2 md:col-span-2">
                <label className="text-sm font-semibold text-gray-700">Message</label>
                <textarea rows="4" placeholder="Write your message..." value={form.message} onChange={(e) => setForm({ ...form, message: e.target.value })} className="w-full px-0 py-2 border-b-2 border-gray-200 focus:outline-none focus:border-[#D4AF37] transition-colors bg-transparent resize-none"></textarea>
              </div>
                ...
                {state.done ? (
                  ...
                  <>
                    ...
                    <button type="submit" disabled={state.busy}
                      className="bg-[#D4AF37] text-[#0A1016] px-10 py-4 rounded-sm font-semibold uppercase tracking-wider text-sm hover:bg-[#B8860B] transition-colors w-full md:w-auto disabled:opacity-60">
