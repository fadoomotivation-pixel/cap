...
// Capital Brix's own profiles, from src/data/site.js. X is absent on purpose:
// there is no Capital Brix handle, and an icon pointing at someone else's
// account is worse than no icon.
