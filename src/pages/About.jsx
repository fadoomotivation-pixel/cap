    ...
    <Seo {...pageSeo.about} />
      ...
      <div className="bg-[#10243E] py-20 text-center text-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6">
          <p className="text-[#9C7C1C] font-bold uppercase tracking-[0.25em] text-sm mb-3">Mirrikh Infratech Pvt. Ltd.</p>
      ...
      <div className="max-w-[1500px] mx-auto px-6 lg:px-12 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          <div>
            <p className="text-[#9C7C1C] font-bold uppercase tracking-[0.25em] text-sm mb-3">Our Story</p>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={s.label} className="bg-white p-5 rounded-sm border border-gray-100 shadow-sm text-center">
                  <div className="text-3xl font-black text-[#9C7C1C] mb-1">{s.val}</div>
          ...
          <div className="bg-[#10243E] rounded-sm p-10 text-white">
            <h3 className="text-2xl font-bold text-[#9C7C1C] mb-4">Our Vision</h3>
            ...
            <h3 className="text-2xl font-bold text-[#9C7C1C] mb-4">Our Mission</h3>
        ...
        {/* Timeline */}
        <div className="mb-20">
          <p className="text-[#9C7C1C] font-bold uppercase tracking-[0.25em] text-sm mb-3 text-center">Our Journey</p>
          <h2 className="text-4xl font-black text-[#10243E] mb-12 text-center">Company Timeline</h2>
          <div className="relative border-l-4 border-[#D4AF37] ml-4 md:ml-24 pl-8 space-y-10">
            {timeline.map((t) => (
              <div key={t.year} className="relative">
                <div className="absolute -left-12 top-1 w-8 h-8 rounded-full bg-[#D4AF37] text-[#0A1016] flex items-center justify-center font-black text-xs">
                  {t.year.slice(2)}
                </div>
                <p className="text-[#9C7C1C] font-black text-lg mb-1">{t.year}</p>
        ...
        {/* Team */}
        <div>
          <p className="text-[#9C7C1C] font-bold uppercase tracking-[0.25em] text-sm mb-3 text-center">Leadership</p>
          ...
          <div className="flex justify-center">
            {team.map(m => (
              <div key={m.name} className="bg-white rounded-sm shadow-sm border border-gray-100 p-8 max-w-sm text-center">
                ...
                <p className="text-[#9C7C1C] font-bold text-sm uppercase tracking-wide mb-4">{m.role}</p>
