        ...
        {error && <div className="bg-red-50 text-red-500 p-3 rounded-md mb-4 text-sm">{error}</div>}
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              ...
              <PasswordInput required className="w-full px-4 py-2 border border-gray-300 rounded-md outline-none focus:border-[#f26522]" value={password} onChange={(e) => setPassword(e.target.value)} />
            </div>
